...
const { User, Beer, Review, Product } = sequelize.models;
...
Product.belongsToMany(Beer, {through: 'product_beer'}) //tabla intermedia
Beer.belongsToMany(Product, {through: 'product_beer'})
