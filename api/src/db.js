...
const { User, Beer, Review, Admin } = sequelize.models;
...
// Relaciones de la administracion - producto 
Admin.belongsToMany(Beer, {through: 'admin_beer'}) //tabla intermedia
Beer.belongsToMany(Admin, {through: 'admin_beer'})
